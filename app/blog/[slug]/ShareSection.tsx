...
export default function ShareSection({ title, slug }: Props) {
  ...
  const twitterHref = `https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encodedUrl}&via=WeCareWellness`;
  ...
  return (
    <div className={styles.share}>
      ...
      <div className={styles.buttons}>
        ...
        <button
          className={`${styles.btn} ${styles.copy} ${copied ? styles.copySuccess : ''}`}
          onClick={handleCopy}
